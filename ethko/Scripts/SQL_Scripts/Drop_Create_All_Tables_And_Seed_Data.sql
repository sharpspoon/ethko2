...
CREATE TABLE [dbo].[Notifications] (
	...
	[N2]       INT    DEFAULT(1)        NOT NULL,
	[N3]       INT    DEFAULT(1)        NOT NULL,
	[N4]       INT    DEFAULT(1)        NOT NULL,
	[N5]       INT    DEFAULT(1)        NOT NULL,
	[N6]       INT    DEFAULT(1)        NOT NULL,
	[N7]       INT    DEFAULT(1)        NOT NULL,
	[N8]       INT    DEFAULT(1)        NOT NULL,
	[N9]       INT    DEFAULT(1)        NOT NULL,
	[N10]       INT    DEFAULT(1)        NOT NULL,
	[N11]       INT    DEFAULT(1)        NOT NULL,
	[N12]       INT    DEFAULT(1)        NOT NULL,
	[N13]       INT    DEFAULT(1)        NOT NULL,
	[N14]       INT    DEFAULT(1)        NOT NULL,
	[N15]       INT    DEFAULT(1)        NOT NULL,
	[N16]       INT    DEFAULT(1)        NOT NULL,
	[N17]       INT    DEFAULT(1)        NOT NULL,
	[N18]       INT    DEFAULT(1)        NOT NULL,
	[N19]       INT    DEFAULT(1)        NOT NULL,
	[N20]       INT    DEFAULT(1)        NOT NULL,
	[N21]       INT    DEFAULT(1)        NOT NULL,
	[N22]       INT    DEFAULT(1)        NOT NULL,
	[N23]       INT    DEFAULT(1)        NOT NULL,
	[N24]       INT    DEFAULT(1)        NOT NULL,
	[N25]       INT    DEFAULT(1)        NOT NULL,
	[N26]       INT    DEFAULT(1)        NOT NULL,
	[N27]       INT    DEFAULT(1)        NOT NULL,
	[N28]       INT    DEFAULT(1)        NOT NULL,
	[N29]       INT    DEFAULT(1)        NOT NULL,
	[N30]       INT    DEFAULT(1)        NOT NULL,
	[N31]       INT    DEFAULT(1)        NOT NULL,
	[N32]       INT    DEFAULT(1)        NOT NULL,
	[N33]       INT    DEFAULT(1)        NOT NULL,
	[N34]       INT    DEFAULT(1)        NOT NULL,
	[N35]       INT    DEFAULT(1)        NOT NULL,
	[N36]       INT    DEFAULT(1)        NOT NULL,
	[N37]       INT    DEFAULT(1)        NOT NULL,
	[N38]       INT    DEFAULT(1)        NOT NULL,
	[N39]       INT    DEFAULT(1)        NOT NULL,
	[N40]       INT    DEFAULT(1)        NOT NULL,
	[N41]       INT    DEFAULT(1)        NOT NULL,
	[N42]       INT    DEFAULT(1)        NOT NULL,
	[N43]       INT    DEFAULT(1)        NOT NULL,
	[N44]       INT    DEFAULT(1)        NOT NULL,
	[N45]       INT    DEFAULT(1)        NOT NULL,
	[N46]       INT    DEFAULT(1)        NOT NULL,
	[N47]       INT    DEFAULT(1)        NOT NULL,
	[N48]       INT    DEFAULT(1)        NOT NULL,
	[N49]       INT    DEFAULT(1)        NOT NULL,
	[N50]       INT    DEFAULT(1)        NOT NULL,
	[N51]       INT    DEFAULT(1)        NOT NULL,
	[N52]       INT    DEFAULT(1)        NOT NULL,
	[N53]       INT    DEFAULT(1)        NOT NULL,
	[N54]       INT    DEFAULT(1)        NOT NULL,
	[N55]       INT    DEFAULT(1)        NOT NULL,
	[N56]       INT    DEFAULT(1)        NOT NULL,
	[N57]       INT    DEFAULT(1)        NOT NULL,
	[N58]       INT    DEFAULT(1)        NOT NULL,
	[N59]       INT    DEFAULT(1)        NOT NULL,
	[N60]       INT    DEFAULT(1)        NOT NULL,
	[N61]       INT    DEFAULT(1)        NOT NULL,
	[N62]       INT    DEFAULT(1)        NOT NULL,
	[N63]       INT    DEFAULT(1)        NOT NULL,
	[N64]       INT    DEFAULT(1)        NOT NULL,
	[N65]       INT    DEFAULT(1)        NOT NULL,
	[N66]       INT    DEFAULT(1)        NOT NULL,
	[N67]       INT    DEFAULT(1)        NOT NULL,
	[N68]       INT    DEFAULT(1)        NOT NULL,
	[N69]       INT    DEFAULT(1)        NOT NULL,
	[N70]       INT    DEFAULT(1)        NOT NULL,
	[N71]       INT    DEFAULT(1)        NOT NULL,
	[N72]       INT    DEFAULT(1)        NOT NULL,
	[N73]       INT    DEFAULT(1)        NOT NULL,
	[N74]       INT    DEFAULT(1)        NOT NULL,
	[N75]       INT    DEFAULT(1)        NOT NULL,
	[N76]       INT    DEFAULT(1)        NOT NULL,
	[N77]       INT    DEFAULT(1)        NOT NULL,
	[N78]       INT    DEFAULT(1)        NOT NULL,
	[N79]       INT    DEFAULT(1)        NOT NULL,
	[N80]       INT    DEFAULT(1)        NOT NULL,
	[N81]       INT    DEFAULT(1)        NOT NULL,
	[N82]       INT    DEFAULT(1)        NOT NULL,
	[N83]       INT    DEFAULT(1)        NOT NULL,
	[N84]       INT    DEFAULT(1)        NOT NULL,
	[N85]       INT    DEFAULT(1)        NOT NULL,
	[N86]       INT    DEFAULT(1)        NOT NULL,
	[N87]       INT    DEFAULT(1)        NOT NULL,
	[N88]       INT    DEFAULT(1)        NOT NULL,
	[N89]       INT    DEFAULT(1)        NOT NULL,
	[N90]       INT    DEFAULT(1)        NOT NULL,
	[N91]       INT    DEFAULT(1)        NOT NULL,
	[N92]       INT    DEFAULT(1)        NOT NULL,
	[N93]       INT    DEFAULT(1)        NOT NULL,
	[N94]       INT    DEFAULT(1)        NOT NULL,
	[N95]       INT    DEFAULT(1)        NOT NULL,
	[N96]       INT    DEFAULT(1)        NOT NULL,
	[N97]       INT    DEFAULT(1)        NOT NULL,
	[N98]       INT    DEFAULT(1)        NOT NULL,
	[N99]       INT    DEFAULT(1)        NOT NULL,
	[N100]       INT    DEFAULT(1)        NOT NULL,
	[N101]       INT    DEFAULT(1)        NOT NULL,
	[N102]       INT    DEFAULT(1)        NOT NULL,
	[N103]       INT    DEFAULT(1)        NOT NULL,
	[N104]       INT    DEFAULT(1)        NOT NULL,
	[N105]       INT    DEFAULT(1)        NOT NULL,
	[N106]       INT    DEFAULT(1)        NOT NULL,
	[N107]       INT    DEFAULT(1)        NOT NULL,
	[N108]       INT    DEFAULT(1)        NOT NULL,
	[N109]       INT    DEFAULT(1)        NOT NULL,
	[N110]       INT    DEFAULT(1)        NOT NULL,
	[N111]       INT    DEFAULT(1)        NOT NULL,
